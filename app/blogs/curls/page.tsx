...
const CurlGuide = () => {
          ...
          <article className="space-y-16 break-words text-neutral-700 dark:text-neutral-300">
            <section>
              ...
              <div className="space-y-5 text-base leading-relaxed">
                <p>
                  cURL is a very fundamental tool for communicating with a
                  server. It stands for <strong>Client URL</strong> and it is a
                  command line tool that basically lets you request and also
                  send the data you want directly from the command line.
                </p>
                <p>
                ...
                <div className="rounded-xl border border-neutral-200 bg-neutral-100 p-5 text-neutral-800 dark:border-neutral-800 dark:bg-neutral-900/50 dark:text-neutral-200">
                  <strong>
                    In this article we will have a deep dive into:
                  </strong>
            ...
            <section>
              ...
              <div className="space-y-5 text-base leading-relaxed">
                ...
                <p>
                  If you are a developer and you want to test any REST API—what
                  is the response type, how the response is formatted, are
                  headers, auth, and payload working correctly, is the API
                  valid, how much time is it taking to respond—everything
                  related to API testing, you would have to specially have
                  different tools and software which was a little inconvenient.
                </p>
                <p>
                  So cURL was made which lets developers like you and us test
                  any API directly from the terminal without any other software
                  tools, drastically increasing productivity and performance.
                </p>
              </div>
            ...
            <section>
              ...
              <div className="space-y-5 text-base leading-relaxed">
                <p>
                  The simplest cURL request is a GET request. (You can send
                  almost any type of REST API request)
                </p>
                ...
                <p className="border-l-2 border-neutral-300 pl-5 dark:border-neutral-700">
                  That&apos;s your first API request (no browser, no extra
                  tools, just the terminal).
                </p>
              </div>
  ...
  https://crud.ba3a.tech/users`}
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-5 dark:border-neutral-800 dark:bg-neutral-900/50">
                  ...
                  <p className="mb-4 text-sm">
                    A request is sent by the client to the server to ask for
                    data or to perform an action.
                  </p>
            ...
            <section>
              ...
              <div className="space-y-5 text-base leading-relaxed">
                <p>
                  cURL is a command-line tool that allows you to communicate
                  with APIs by sending HTTP requests directly from the terminal.
                  Using cURL, you can specify the request method, pass headers,
                  send data in the request body, and inspect the server&apos;s
