          ...
          <article className="space-y-16 text-neutral-700 dark:text-neutral-300">
            <section>
              ...
              <div className="space-y-5 text-base leading-relaxed">
                <p>
                  → It is the phonebook of the internet. Humans access info
                  using domain names but in the background each site is running
                  on a machine which can be hosted on cloud machines or bare
                  metal which have a unique public IP which is hard for humans
                  to remember, so we use domain names that are easy to read.
                </p>
                <p>
                  → For now, in short, we can say DNS translates domain names to
                  IP addresses where the site is hosted. But it is not that
                  simple (domain name ↔ IP). Before getting the IP, it sends
                  recursive requests to different types of servers to finally
                  get the IP.
                </p>
            ...
            <section>
              ...
              <p className="mb-6 text-base leading-relaxed">
                ...
                <strong>Domain Information Groper</strong>, is a command-line
                tool used to query DNS servers. It retrieves detailed DNS
                information such as IP addresses (A/AAAA records), mail servers
                (MX records), name servers (NS records), and other DNS record
                types.
              </p>
            ...
            <section>
              ...
              <div className="space-y-6 text-base leading-relaxed">
                ...
                <p>
                  ...
                  hierarchy. First, it will go to the root name server
                  (resolving example: &quot;.com&quot;), then to the particular
                  TLD nameserver (in this case, .com), and finally the
                  authoritative name server, which will finally return the IP
                  and also cache it for future queries. Recursive servers do not
                  host any records—they just cache to reduce the load on the
                  main servers.
                </p>
              </div>
            ...
            <section className="rounded-xl border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-800 dark:bg-neutral-900/40">
              ...
              <p className="mb-6">
                The <strong>dig</strong> command is a powerful Linux utility
                used to query DNS servers for detailed information about domain
                names.
              </p>
              ...
              <div className="space-y-5">
                ...
                <div className="border-t border-neutral-200 pt-5 dark:border-neutral-800">
                  ...
                  <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
                    <li>
                      • If no record type is specified, dig defaults to A
                      records.
                    </li>
            ...
            <section>
              ...
              <p className="mb-8 text-base leading-relaxed">
                ...
                recursor server. You can think of a root server like an index in
                a library that points to different racks of books. There are
                mainly 13 logical root name servers, each identified by a unique
                name and IP address.
              </p>
            ...
            <section>
              ...
              <p className="mb-8 text-base leading-relaxed">
                ...
                next step in the search for a specific IP address and it hosts
                the last portion of the hostname.
              </p>
            ...
            <section>
              ...
              <div className="space-y-5">
                <p>
                  dig google.com NS queries the authoritative name servers for
                  the domain by requesting NS records.
                </p>
