...
const NavBar = () => {
  ...
  return (
    <nav
      ...
      className="sticky top-0 z-100 flex items-center justify-between px-8 py-3 backdrop-blur-[7px] sm:px-[52px] md:mx-auto md:max-w-[1200px] md:justify-around md:px-0"
    >
