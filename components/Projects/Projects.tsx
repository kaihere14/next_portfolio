...
const projects: ProjectType[] = [
  ...
  {
    id: "clura-auth-provider",
    name: "Clura - Open Source Auth Provider",
    tagline: "Self-hosted OAuth 2.0 / OIDC identity provider",
    description:
      "A self-hosted alternative to Clerk and Auth0. Developers register their apps, redirect users to Clura's hosted login, and get RS256-signed JWTs back ID token, access token, and rotating refresh token all verifiable via a public JWKS endpoint with zero SDK required.",
    image: "/clura.webp",
    tech: [
      "Next.js",
      "TypeScript",
